...
class AdsCampaignType {
  ...
  static const AdsCampaignType vkAppsManaged = AdsCampaignType._('vk_apps_managed');

  static const AdsCampaignType mobileApps = AdsCampaignType._('mobile_apps');

  static const AdsCampaignType promotedPosts = AdsCampaignType._('promoted_posts');

  static List get values => const ['normal', 'vk_apps_managed', 'mobile_apps', 'promoted_posts'];
