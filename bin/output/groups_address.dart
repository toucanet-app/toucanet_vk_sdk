import 'groups_address_timetable.dart';
import 'groups_address_work_info_status.dart';
...
class GroupsAddress {
  ...
  final GroupsAddressTimetable timetable;

  /// Title of the place (Zinger, etc).
  final String title;

  /// Status of information about timetable.
  final GroupsAddressWorkInfoStatus workInfoStatus;
  ...
  factory GroupsAddress.fromMap(Map<String, dynamic> map) {
    return GroupsAddress(
      ...
      timetable: GroupsAddressTimetable.fromMap(map['timetable']),
      title: map['title'] as String,
      workInfoStatus: GroupsAddressWorkInfoStatus(map['work_info_status']),
    );
  }
}
