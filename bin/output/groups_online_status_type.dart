...
class GroupsOnlineStatusType {
  ...
  static const GroupsOnlineStatusType online = GroupsOnlineStatusType._('online');

  static const GroupsOnlineStatusType answerMark = GroupsOnlineStatusType._('answer_mark');
