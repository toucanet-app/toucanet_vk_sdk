...
class GroupsOwnerXtrBanInfoType {
  ...
  static const GroupsOwnerXtrBanInfoType group =
      GroupsOwnerXtrBanInfoType._('group');

  static const GroupsOwnerXtrBanInfoType profile =
      GroupsOwnerXtrBanInfoType._('profile');
