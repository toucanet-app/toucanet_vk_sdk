...
class GroupsUserXtrRole {
  ...
  final GroupsRoleOptions role;

  const GroupsUserXtrRole({
    this.deactivated,
  ...
  factory GroupsUserXtrRole.fromMap(Map<String, dynamic> map) {
    return GroupsUserXtrRole(
      ...
      role: GroupsRoleOptions(map['role']),
    );
  }
}
