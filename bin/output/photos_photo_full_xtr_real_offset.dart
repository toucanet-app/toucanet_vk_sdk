...
class PhotosPhotoFullXtrRealOffset {
  ...
  final BasePropertyExists hidden;
  ...
  const PhotosPhotoFullXtrRealOffset({
    this.accessKey,
  ...
  factory PhotosPhotoFullXtrRealOffset.fromMap(Map<String, dynamic> map) {
    return PhotosPhotoFullXtrRealOffset(
      ...
      hidden: BasePropertyExists(map['hidden']),
      id: map['id'] as int,
