...
class UsersUserXtrCounters {
  ...
  final UsersUserCounters counters;

  const UsersUserXtrCounters({
    this.deactivated,
  ...
  factory UsersUserXtrCounters.fromMap(Map<String, dynamic> map) {
    return UsersUserXtrCounters(
      ...
      counters: UsersUserCounters.fromMap(map['counters']),
    );
  }
}
