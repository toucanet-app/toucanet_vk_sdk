...
import 'vk_apps_app_leaderboard_type.dart';
...
class VKAppsApp {
  ...
  /// Is new flag.
  final VKBaseBoolInt isNew;

  /// Is push enabled.
  final VKBaseBoolInt pushEnabled;
  ...
  final VKAppsAppLeaderboardType leaderboardType;
  ...
  factory VKAppsApp.fromMap(Map<String, dynamic> map) {
    ...
    return VKAppsApp(
      ...
      isNew: VKBaseBoolInt(map['is_new']),
      pushEnabled: VKBaseBoolInt(map['push_enabled']),
      ...
      leaderboardType: VKAppsAppLeaderboardType(map['leaderboard_type']),
