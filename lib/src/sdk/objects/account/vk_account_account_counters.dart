class VKAccountAccountCounters {
  ...
  const VKAccountAccountCounters({
    this.appRequests,
    this.events,
    this.faves,
    this.friends,
  ...
  factory VKAccountAccountCounters.fromMap(Map<String, dynamic> map) {
    if (map == null) return null;

    return VKAccountAccountCounters(
