...
class VKFriendsUserXtrLists {
  ...
  /// The list of IDs of friend lists with user.
  final List<int> lists;

  const VKFriendsUserXtrLists({
    this.deactivated,
  ...
  factory VKFriendsUserXtrLists.fromMap(Map<String, dynamic> map) {
    return VKFriendsUserXtrLists(
