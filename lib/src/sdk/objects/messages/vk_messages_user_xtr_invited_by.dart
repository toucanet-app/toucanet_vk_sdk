...
import '../users/vk_users_user_type.dart';

class VKMessagesUserXtrInvitedBy {
  ...
  const VKMessagesUserXtrInvitedBy({
    this.deactivated,
  ...
  factory VKMessagesUserXtrInvitedBy.fromMap(Map<String, dynamic> map) {
    if (map == null) return null;

    return VKMessagesUserXtrInvitedBy(
