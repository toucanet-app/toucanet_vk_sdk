...
class VKGroupsEditAddressResponse {
  ...
  const VKGroupsEditAddressResponse({
  ...
  factory VKGroupsEditAddressResponse.fromMap(Map<String, dynamic> map) {
    return VKGroupsEditAddressResponse(
